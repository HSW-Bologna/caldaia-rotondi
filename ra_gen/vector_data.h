...
#define VECTOR_NUMBER_ADC0_WINDOW_A ((IRQn_Type) 2) /* ADC0 WINDOW A (Window A Compare match interrupt) */
#define ADC0_WINDOW_A_IRQn          ((IRQn_Type) 2) /* ADC0 WINDOW A (Window A Compare match interrupt) */
