...
#include "r_elc_api.h"
const elc_cfg_t g_elc_cfg = { .link[ELC_PERIPHERAL_GPT_A] = ELC_EVENT_NONE, /* No allocation */
...
.link[ELC_PERIPHERAL_ADC0] = ELC_EVENT_GPT4_COUNTER_OVERFLOW, /* GPT4 COUNTER OVERFLOW (Overflow) */
